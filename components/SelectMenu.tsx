...
interface Props {
    ...
    setValue: Dispatch<SetStateAction<{ country: string; city: string; }>>;
    formikProps: any;
}
            ...
            >
                ...
                <Input
                    ...
                    onChange={(e) => {
                        ...
                        setLocation(prev => { return { ...prev, country: e.target.value } });
                    ...
                    {countries.map((country) => {
                        return (
                            <span
                                ...
                                key={country.id}
                                onClick={() => {
                                    setValue(prev => { return { ...prev, country: country.id } });
                                    setLocation(prev => { return { ...prev, country: country.name } });
            ...
            >
                ...
                <Input
                    ...
                    onChange={(e) => {
                        ...
                        setLocation(prev => { return { ...prev, city: e.target.value } });
                    ...
                    {cities.map((city) => {
                        return (
                            ...
                            className="cursor-pointer w-full text-center  p-1.5 rounded-md hover:bg-slate-400 "
                                key={city.id}
                                onClick={() => {
                                    setValue(prev => { return { ...prev, city: city.name } });
                                    setLocation(prev => { return { ...prev, city: city.name } });
                                    setShowCities(false);
                                }}
                            >
                                {city.name}
